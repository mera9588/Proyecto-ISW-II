...
<div class="jumbotron" id="wellcome">
	...
	<p>Favor seleccionar un rango de fechas (fecha inicial - fecha final) en las opciones de abajo.</p>
</div>
<div class="well">
		<table class="table table-bordered">
				<thead>
					<tr>
						<th>Fecha de inicio <a href="#" class="btn btn-sm btn-default" id="dp4" data-date-format="yyyy-mm-dd" data-date="2012-02-20">Cambiar</a></th>
